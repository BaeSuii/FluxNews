...
// Unused Colors --------------------------------------
// val statusBarColorLight = Color(0xFFE9EEFA)
// val statusBarColorNight = Color(0xFF1A1A1A)

// val systemSuccessLight = Color(0xFF0D942B)
// val systemWarningLight = Color(0xFFFE4F32)
// val systemInfoLight = Color(0xFF2D5BD0)

// val systemSuccessNight = Color(0xFF0FAB31)
// val systemWarningNight = Color(0xFFFE664B)
// val systemInfoNight = Color(0xFF416BD6)